...
| P1 | Pruebas de integración reales de los proveedores | Los unit tests son fuertes, pero la CI excluye E2E y el chequeo de tipos no bloquea. Falta una matriz controlada de Codex, Claude y OpenCode: arranque, prompt, hijo cruzado, mensaje entre hermanos, cancelación y reconciliación. |
